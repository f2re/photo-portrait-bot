    ...
    if start_param:
        if start_param.lower() in ['payment', 'buy', 'price', 'packages']:
            ...
            text = (
                ...
                f"🎁 Бесплатно: 3 фото (у вас: {balance['free']})\n"
                "━━━━━━━━━━━━━━━━━━\n\n"
                ...
                if referrer_set:
                    ...
                    try:
                        await message.bot.send_message(
                            ...
                            f"🎁 Вам начислено <b>{settings.REFERRAL_REWARD_START}</b> бесплатных портретов!\n\n"
                            f"Продолжайте делиться ссылкой и создавайте больше образов! 👥",
                            parse_mode="HTML"
                        )
                    except Exception:
                        pass
...
async def packages_handler(message: Message):
    ...
    text = (
        "💎 <b>Доступные пакеты:</b>\n\n"
        f"🎁 Бесплатно: 3 фото (осталось: {balance['free']})\n"
        "━━━━━━━━━━━━━━━━━━\n\n"
